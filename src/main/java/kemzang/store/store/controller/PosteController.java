...
public class PosteController {
 ...
 public String savePoste(@Valid @ModelAttribute("poste") Poste poste,
  ...
  if (bindingResult.hasErrors()) {
   return "poste/addposte"; // Retournera à la vue avec les erreurs
  }
 ...
 public String listeEmployesByPoste(@PathVariable UUID id, Model model) {
  ...
  // Liste des employés du poste dont l'id est {id}
 ...
 public String update(@PathVariable UUID id,
  ...
  // On teste si les données saisies dans le formulaire sont validées
  if (bindingResult.hasErrors()) {
   return "poste/editposte"; // Retournera à la vue avec les erreurs
  }
